<html lang="en">
   <head>
       ...
       <script async src="https://analytics.revengeos.com/tracker.js" data-ackee-server="https://analytics.revengeos.com" data-ackee-domain-id="ea2c68b0-854e-4537-9cd1-5dcfa73f6bd0"></script>
   ...
   <body data-page="README.md" class="ready">
      ...
      <section class="cover show" style="background: linear-gradient(to right, #d3cce3, #e9e4f0);">
         <div class="mask"></div>
            ...
            <div class="container-flexible">
               <div class="container-flexible">
                  <div class="row justify-content-center">
                     ...
                     <div class="col-auto">
                        <li><a href="https://twitter.com/itsrevengeos" target="_blank" class="fab fa-twitter fa-2x"><span class="label"></span></a></li>
                     </div>
                     <div class="col-auto">
                        <li><a href="https://discord.com/invite/vWqjM8B" target="_blank" class="fab fa-discord fa-2x"><span class="label"></span></a></li>
                     </div>
                     <div class="col-auto">
                        <li><a href="https://www.paypal.com/paypalme/lucchetto" target="_blank" class="fab fa-paypal fa-2x"><span class="label"></span></a></li>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <main>
         <button onclick="myFunction();" class="sidebar-toggle" aria-label="Menu">
   ...
   <li>
      <p>Lenovo</p>
      <ul>
         <div id=lenovoslider></div>
      </ul>
   </li>
   <li>
      <p>Moto</p>
      <ul>
         <div id=motorolaslider></div>
      </ul>
   </li>
   <li>
      <p>Oneplus</p>
      <ul>
         <div id=oneplusslider></div>
      </ul>
   </li>
      <li>
      <p>Realme</p>
